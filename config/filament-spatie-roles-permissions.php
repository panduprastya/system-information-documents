...
return [
    ...
    'navigation_section_group' => 'Settings', // Changed to Settings group
    ...
    'should_show_permissions_for_roles' => false, // Hide permissions field in role form
    ...
    'should_redirect_to_index' => [
        ...
        'roles' => [
            'after_create' => true, // Redirect to index after create
            'after_edit' => true // Redirect to index after edit
        ],
    ],
    ...
    'default_guard_name' => 'web', // Set default guard to web

    // if false guard option will not be show on screen. You should set a default_guard_name in this case
    'should_show_guard' => false, // Hide guard field, use default_guard_name instead
